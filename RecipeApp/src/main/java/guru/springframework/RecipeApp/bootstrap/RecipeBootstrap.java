...
import guru.springframework.RecipeApp.model.Diffuculty;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public RecipeBootstrap(CategoryRepository categoryRepository, RecipeRepository recipeRepository, UnitOfMeausureRepository unitOfMeasureRepository) {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        Ingredient ingredient = new Ingredient("Deneme",new BigDecimal(1),
        		unitOfMeasureRepository.findByDescription("Each").get(),
        		recipes.get(0));
        recipes.get(0).getIngredients().add(ingredient);
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.setDiffuculty(Diffuculty.EASY);
        ...
        //guacNotes.setRecipe(guacRecipe);  -- not needed anymore bec of Logic setter --
        ...
        //Save islemi MappedBy Entitiy'sinden(Recipy) yapildigi icin, önce JC tarafı entity(Ingredient) olusturduk ve buna ilsiki
        //kuracagi recipy nesnesini set ettik. Daha sonra Recipy(MappedBy) kısmınnı save ettik, o da cascadetype all oldugu icin
        //Ingredient de save edildi ve iliski kuruldu
        ...
        //Artık MappedBy tarafindan(Recipe) save edekeren; JC Tarafını(Ingredient) olusturdugumuza, recipe'sini set etmeye gerek kalmadı cünkü, recipe'nin addGradient metodunda
        //hem gredient'e recipeyi hem de recipedeki gredients listesine gredient'i ekledik.
